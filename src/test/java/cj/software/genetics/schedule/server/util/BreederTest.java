...
class BreederTest {
    ...
    void metadata() throws NoSuchMethodException {
        ...
        Method method = Breeder.class.getDeclaredMethod("step", Population.class, int.class, int.class);
    ...
    void allElitism() {
        ...
        Population next = breeder.step(population, 3, 5);
    ...
    void oneElitism() {
        ...
        Population next = breeder.step(population, elitismCount, tournamentSize);
